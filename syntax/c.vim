...
hi def link cStorageClass	xGreen
...
"
" " Eigene Typen
"syntax match xGreen "[a-zA-Z_0-9]*_t[;\t\ ]\?"

" Funktioniert
"syntax match xGreen "[a-zA-Z_0-9]*_t\(\ \?\*\+\)\?[;\t\ )]"me=e-1
syntax match xGreen "[a-zA-Z_0-9:]*_t[;\t\ )]"me=e-1
"syntax match xGreen "\(struct\|union\|enum\)\ [a-zA-Z_0-9]*[;\t\ )]"me=e-1
"syn keyword	cStructure	struct union enum typedef
syn keyword xRed struct union enum typedef
"syntax keyword cStructure typedef

""syntax match xGreen "[a-zA-Z_0-9]*_t[^a-zA-Z0-9_-]\?[;\t\ ]"me=e-1
"[^a-zA-Z0-9_-]"
syntax keyword xGreen byte word dword qword sbyte sword sdword sqword addr
syntax match xYellow "[a-zA-Z_0-9]\+->"
"syntax match xRed "_\?[A-Z]\+[A-Z_0-9]*\A"me=e-1
syntax match xRed "_\?[A-Z]\+[A-Z_0-9]*\A"me=e-1
"syntax match xYellow "\*\+[a-zA-Z_0-9\.>:-]\+"
"syntax match xYellow "&\?&[a-zA-Z_0-9\.>:-]\+"
syntax match xYellow "\*\+[a-zA-Z_:][a-zA-Z_0-9\.>:-]*"
syntax match xYellow "&\?&\+[a-zA-Z_:][a-zA-Z_0-9\.>:-]*"
syntax match xYellow "[a-zA-Z_0-9\.>:-]\+\*\+"
"syntax match xYellow "[a-zA-Z_0-9\.>:-]\+&&\?"
