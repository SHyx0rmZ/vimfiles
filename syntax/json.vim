...
if version >= 508 || !exists("did_json_syn_inits")
  ...
  HiLink jsonString             xYellow
  HiLink jsonEscape             xRed
  HiLink jsonNumber		xGreen
  HiLink jsonBraces	        xRed
  HiLink jsonNull		xBlue
  HiLink jsonBoolean		xBlue

  HiLink jsonNumError           Comment
  HiLink jsonStringSQ           Comment
  HiLink jsonNoQuotes           Comment
  delcommand HiLink
endif
